...
public class Task3Tests {
  ...
  public void correctlyWorkTesting() {
    ...
    List<Figures> result = Task3.getSortedFiguresByVolume(figuresList);
  ...
  public void nullTesting(){
    List<Figures> result = Task3.getSortedFiguresByVolume(null);

    assertNull(result);
  }
  @Test
  public void emptyListTesting(){
    List<Figures> result = Task3.getSortedFiguresByVolume(new ArrayList<>());
